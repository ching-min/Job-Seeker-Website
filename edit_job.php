...
<html lang="en">
	...
	{echo "hi ".$_SESSION['username']."!!<br>";//印出上方列
		...
		while($result=$sth->fetchObject()){
				...
				else if($result->id==$action)
				{ ?>
					<form action="editjob_post.php"method="POST">
					<!--//增加的選取欄 occupation -->	
		...
		<option value="10">10 years</option>
				...
				<?php	echo'<input name="action" type="hidden" value='. $result->id . '>'; ?>
					<!--Salary-->
					<input type="number" min="10000" step="1000" value="10000" name="Salary"></td><td>
