...
if(!$user){
	...
	header("Location:http://people.cs.nctu.edu.tw/~tsaimy8112/Jobseeker_signup.php");
	exit;
}
if(!$passwd){
...
/*----插入----*/
$sql="INSERT INTO `tsaimy8112_cs`.`user` (`account`,`password`,`education`,`expected_salary`,`phone`,`gender`,`age`,`email`)"
	."VALUES(?,?,?,?,?,?,?,?)";
